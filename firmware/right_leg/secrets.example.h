...
// Login for the web dashboard (username / password prompt in the browser).
// Leave DASHBOARD_PASSWORD as "" to disable the login (not recommended).
#define DASHBOARD_USER     "stridemate"
#define DASHBOARD_PASSWORD "change-me-dashboard"
